        ...
        <div className="max-w-6xl mx-auto flex flex-col xl:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 w-full xl:w-auto">
            ...
            <button
              ...
              className={`h-12 px-8 rounded-full font-medium flex items-center justify-center gap-2 shadow-lg transition-all active:scale-95 w-full md:w-auto whitespace-nowrap ${!selectedFile
